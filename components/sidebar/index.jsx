...
const Sidebar = () => {
  ...
  return (
    <nav className={styles.mainmenu}>
      ...
      <div className="flex flex-col gap-3 mt-2 h-screen">
        <button
          className={
          ...
          <div>
            ...
            >
              <path
                ...
                fill={
                  isSelect == "/" || isSelect == "/live" ? "#FFFFFF" : "#FF0000"
                }
              />
            </svg>
          </div>
        ...
        {/* <div className={classnames(styles.signgroupbuttonmt, "text-center")}>
          <button
            type="button"
          ...
          <button
            type="button"
            className="px-2 py-2 mt-3 text-lg font-medium leading-6 text-center text-white uppercase transition bg-red-600 border-2 border-red-500 rounded-full ripple focus:outline-none w-40 content-center"
          >
            SIGN UP
          </button>
        </div> */}
